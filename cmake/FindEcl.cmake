...
if(ECL_FOUND AND NOT TARGET Ecl::Ecl)
  add_library(Ecl::Ecl INTERFACE IMPORTED)
  set_target_properties(Ecl::Ecl PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES "${ECL_INCLUDE_DIR}"
      INTERFACE_LINK_LIBRARIES "${ECL_LIBRARIES}")
endif()
